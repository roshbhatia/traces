...
var keyBindings = []keyBinding{
	...
	{id: "edit", keys: "e", description: "open the row's whole text in $EDITOR", help: true},
	...
	{id: "leader-edit", keys: "<space> e", short: "edit", description: "open the raw row text in $EDITOR", help: true, leader: true},
